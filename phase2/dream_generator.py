...
class DreamGenerator:
    ...
    def _get_activated_signifiers_from_memories(self) -> List[Dict[str, Any]]:
        """
        Get signifiers activated from recent memory content.
        
        This is the core improvement: dreams emerge from actual memory activation
        rather than arbitrary text processing.
        """
        activated = []
        ...
        for signifier_obj in self.unconscious_memory.get("signifiers", []):
            ...
            if signifier_name.lower() in memory_text:
                activated.append({
